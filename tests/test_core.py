...
class TestContrastivePairs:
    ...
    def test_pairs_have_different_content(self):
        ...
        for pair in HARMFUL_CONTENT_PAIRS[:5]:
            ...
            harmful_words = [
                'harm', 'kill', 'bomb', 'hack', 'poison', 'steal', 'illegal', 
                'hurt', 'fake', 'explosive', 'weapon', 'attack', 'murder',
                'dangerous', 'deadly', 'threaten', 'manipulate', 'exploit',
                'methamphetamine', 'drug', 'manufacture', 'chemical'
            ]
            assert any(word in pair.positive.lower() for word in harmful_words), \
